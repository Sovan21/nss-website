...
// YouTube-style Registered Volunteer Search Autocomplete Component (A to Z order)
const VolunteerSearchAutocomplete = ({ registrations, selectedVolId, onSelectVolunteer }) => {
  ...
  // Sort registrations in A to Z ascending order by full_name
  ...
  // Filter sorted volunteers based on query
  ...
  return (
    <div ref={containerRef} className="relative w-full">
      ...
      {/* YouTube-like Suggestions Panel Overlay */}
      {isOpen && (
...
const CommitteeManager = ({ setIsDirty }) => {
  ...
  // Main Tab: 'teachers' | 'volunteers'
  const [mainTab, setMainTab] = useState('teachers');
  
  // Sub Category Filter for Volunteer Committee: 'All' | 'Student' | 'Cultural' | 'Environment'
