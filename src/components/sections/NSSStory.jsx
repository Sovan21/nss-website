        ...
        <div className="mt-16 bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-950 rounded-3xl p-6 md:p-10 shadow-2xl border border-slate-800/80 scroll-reveal relative overflow-hidden group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center relative z-10">
...
}assName="mt-4 px-3 py-1 bg-blue-500/10 border border-blue-500/20 rounded-full text-[10px] md:text-xs font-black text-blue-400 uppercase tracking-widest">
                NSS India #1
              </span>
            </div>
            ...
            <div className="md:col-span-8 flex flex-col">
              ...
              <p className="text-xs md:text-sm font-extrabold text-indigo-400 uppercase tracking-widest mb-4">
                The First NSS Volunteer of India
              </p>
              
              <p className="text-xs md:text-base text-slate-300 leading-relaxed font-semibold mb-6">
                Formally recognized as India's very first NSS volunteer, Mr. K.K. Gupta enrolled during the historic first orientation camp at Rajghat, Kirori Mal College (University of Delhi) in June 1969. For decades, he has remained an active guide and a source of inspiration for millions of young volunteers across the nation.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full text-xs md:text-sm font-black shadow-lg shadow-blue-600/20 hover:scale-105 transition-all duration-300"
                >
                  <Icons.Facebook className="w-4 h-4" /> Connect on Facebook
                </a>
              </div>
            </div>
          </div>
...
const CALENDAR_EVENTS = [
  { date: "2026-01-11", endDate: "2026-01-17", title: "Observation of Road Safety Week", type: "social", desc: "Public awareness drives on road traffic rules, helmet safety, and safe driving behaviors." },
  { date: "2026-01-12", title: "Observation of National Youth Day", type: "nat", desc: "Commemorating Swami Vivekananda's birth anniversary with youth rallies, debates, and motivation talks." },
  { date: "2026-01-23", title: "Parakram Diwas (Netaji Subhash Chandra Bose Birth Anniversary)", type: "hist", desc: "Tribute to Netaji with seminars on his legacy and patriotic assemblies." },
  { date: "2026-01-25", title: "National Voters Day", type: "nat", desc: "Electoral literacy campaigns and voter pledge signature drives for eligible students." },
  { date: "2026-01-26", title: "Observation of Republic Day", type: "nat", desc: "Flag hoisting, parade participation, and community awareness activities." },
  { date: "2026-02-21", title: "Observation of National Mother Language Day", type: "social", desc: "Celebrating language diversity and mother tongues with cultural programs and poetry readings." },
  { date: "2026-02-28", title: "National Science Day", type: "nat", desc: "Science exhibitions, seminars on technology advancements, and quizzes for student outreach." },
  { date: "2026-03-08", title: "Observation of International Women's Day", type: "social", desc: "Advocating for gender equality, honoring achievements, and seminars on women's empowerment." },
  { date: "2026-03-21", title: "Programme Officer Out of Pocket Allowance (Unit-I)", type: "admin", desc: "Official administrative planning and audit clearance for NSS Unit-I Programme Officer." },
  { date: "2026-03-24", title: "Office Expenses Management (NSS Unit-I)", type: "admin", desc: "Year-end financial auditing, resource management, and administrative budget settlement." },
  { date: "2026-04-22", title: "Observation of International Mother Earth Day", type: "env", desc: "NSS volunteers observe Earth Day to promote environmental consciousness and tree plantation." },
  { date: "2026-05-22", title: "Observation of Raja Ram Mohan Roy Birth Anniversary", type: "hist", desc: "Paying tribute to the father of modern Indian Renaissance with educational talks." },
  { date: "2026-05-31", title: "Observation of World No-Tobacco Day", type: "health", desc: "Raising awareness against tobacco use and its impact on personal and public health." },
  { date: "2026-06-03", title: "Observation of Bicycle Day", type: "health", desc: "Promoting sustainable transportation and physical wellness through cycle rallies." },
  { date: "2026-06-05", title: "Observation of World Environment Day", type: "env", desc: "Large scale tree plantation drives, green campus initiatives and cleaning sessions." },
  { date: "2026-06-07", title: "Observation of Food Safety Day", type: "health", desc: "Spreading awareness regarding nutrition and food hygiene to prevent foodborne illness." },
  { date: "2026-06-12", title: "Observation of World Day Against Child Labour", type: "social", desc: "Advocating for children's rights and education through rallies and talks." },
  { date: "2026-06-14", title: "Observation of World Blood Donor Day (Blood Donation Camp)", type: "health", desc: "NSS Unit organizes a voluntary blood donation camp in association with local blood banks." },
  { date: "2026-06-21", title: "Observation of International Yoga Day", type: "health", desc: "Practical yoga sessions, meditation guidance and mental wellness talks." },
  { date: "2026-07-01", title: "Observation of National Doctor's Day", type: "health", desc: "Honoring healthcare professionals and conducting medical awareness seminars." },
  { date: "2026-07-11", title: "Observation of World Population Day", type: "social", desc: "Discussions and seminars on population growth trends, resource distribution, and management." },
  { date: "2026-07-14", endDate: "2026-07-20", title: "Observation of Arannya Saptaha", type: "env", desc: "A week-long celebration focused on afforestation, nature walks, and environmental conservation." },
  { date: "2026-08-15", title: "Observation of Independence Day", type: "nat", desc: "Flag hoisting ceremony, patriotic cultural events, and social service pledges." },
  { date: "2026-08-29", title: "Observation of National Sports Day", type: "health", desc: "Promoting physical fitness, sportsmanship, and organizing athletic events for volunteers." },
  { date: "2026-09-23", title: "Observation of Swachhata Hi Seva Campaign", type: "env", desc: "Intensive cleanliness drives, plastic-free campaigns, and swachhata pledge ceremonies." },
  { date: "2026-09-24", title: "Celebration of NSS Day", type: "nss", desc: "Commemorating the foundation of NSS in India with cultural events, award recognition, and social pledges." },
  { date: "2026-10-02", title: "Gandhi Jayanti & Swachh Bharat Abhiyan", type: "hist", desc: "Celebrating the birth anniversary of Mahatma Gandhi with cleanliness drives and non-violence rallies." },
  { date: "2026-10-31", title: "National Unity Day (Birth Anniversary of Sardar Vallabhbhai Patel)", type: "nat", desc: "Run for Unity rally, integrity pledge, and community integration programs." },
  { date: "2026-11-26", title: "Observation of National Constitution Day", type: "nat", desc: "Reading the Preamble, organizing quizzes and guest lectures on constitutional rights and duties." },
  { date: "2026-12-01", title: "Observation of World AIDS Day & Pollution Prevention Day", type: "health", desc: "Awareness campaigns, red ribbon rallies, and workshops on environmental pollution hazards." },
  { date: "2026-12-05", title: "Observation of International Volunteers Day", type: "nss", desc: "Acknowledging and celebrating the contribution of selfless student volunteers and change-makers." }
];
...
function NSSCalendar() {
  ...
  const getTypeStyle = (type) => {
    switch (type) {
      case "env": return { bg: "bg-emerald-500", border: "border-emerald-500", text: "text-emerald-500", lightBg: "bg-emerald-500/10 border-emerald-500/20 text-emerald-300", label: "Environment" };
      case "health": return { bg: "bg-rose-500", border: "border-rose-500", text: "text-rose-500", lightBg: "bg-rose-500/10 border-rose-500/20 text-rose-300", label: "Health & Hygiene" };
      case "social": return { bg: "bg-blue-500", border: "border-blue-500", text: "text-blue-500", lightBg: "bg-blue-500/10 border-blue-500/20 text-blue-300", label: "Social Awareness" };
      case "nat": return { bg: "bg-amber-500", border: "border-amber-500", text: "text-amber-500", lightBg: "bg-amber-500/10 border-amber-500/20 text-amber-300", label: "National Observance" };
      case "hist": return { bg: "bg-indigo-500", border: "border-indigo-500", text: "text-indigo-500", lightBg: "bg-indigo-500/10 border-indigo-500/20 text-indigo-300", label: "Memorial Day" };
      case "nss": return { bg: "bg-violet-500", border: "border-violet-500", text: "text-violet-500", lightBg: "bg-violet-500/10 border-violet-500/20 text-violet-300", label: "NSS Celebration" };
      case "admin": return { bg: "bg-slate-500", border: "border-slate-500", text: "text-slate-500", lightBg: "bg-slate-500/10 border-slate-500/20 text-slate-300", label: "Administrative" };
      default: return { bg: "bg-blue-500", border: "border-blue-500", text: "text-blue-500", lightBg: "bg-blue-500/10 border-blue-500/20 text-blue-300", label: "General" };
    }
  };
    ...
    <section className="relative py-12 md:py-20 px-4 sm:px-6 lg:px-8 bg-slate-950 overflow-hidden border-t border-white/5">
      ...
      <div ref={containerRef} className="max-w-6xl mx-auto relative z-10">
        <SectionHeader
          ...
          headingAccent="2026"
          subtitle="Explore the interactive calendar of social activities, national observances, and camps planned by the NSS Unit I & II."
          light
        />
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-8">
          ...
          {viewMode === "agenda" ? (
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-start">
              ...
              <span className="text-sm sm:text-base font-black text-white uppercase tracking-wider text-center min-w-[140px] truncate">{activeMonth.name}</span>
              <button
            ...
            <div className="lg:col-span-5 flex flex-col">
              {selectedEvent ? (
                <div className="flex-1 bg-gradient-to-b from-white/5 to-white/[0.02] border border-white/10 rounded-3xl p-6 md:p-8 backdrop-blur-md shadow-2xl flex flex-col justify-between h-full group">
                  ...
                  <div className="bg-white/[0.02] rounded-2xl border border-white/5 p-4 flex items-start gap-3 mt-6">
                    ...
                    <p className="text-[11px] text-slate-400 font-semibold leading-relaxed">
                      NSS volunteer programs are active during college hours. Volunteers are advised to check dynamic notifications.
                    </p>
                  </div>
                </div>
              ) : (
                <div className="flex-1 bg-white/[0.01] border border-dashed border-white/10 rounded-3xl p-8 backdrop-blur-md shadow-2xl flex flex-col items-center justify-center text-center text-slate-500 h-full">
                  ...
                  <p className="font-extrabold text-slate-400 tracking-tight text-sm">No Events This Month</p>
                  <p className="text-xs text-slate-500 font-semibold mt-1 max-w-[240px] leading-relaxed">Please navigate months or select a highlighted day on the sheet.</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-5 md:p-8 backdrop-blur-md shadow-2xl max-h-[500px] overflow-y-auto custom-scrollbar">
            {filteredAgendaEvents.length === 0 ? (
              <div className="text-center py-16 text-slate-500 flex flex-col items-center">
                ...
                <p className="font-extrabold text-slate-400 text-sm">No matching events found</p>
              </div>
            ) : (
                      ...
                      <div className="flex-1">
                        <div className="flex flex-wrap gap-2 items-center mb-2">
                          ...
                          <span className="text-xs text-slate-400 font-bold flex items-center gap-1">
                            <Icons.Calendar className="w-3.5 h-3.5" />
                            {evt.endDate ? `${formatDate(evt.date)} to ${formatDate(evt.endDate)}` : formatDate(evt.date)}
                          </span>
                        </div>
