      ...
      <html>
        <head>
          ...
          <style>
            @page {
              size: A4 portrait;
              margin: 0; /* Completely removes browser default header (date, title) and footer (URL, page numbers) */
            }
            * {
            ...
            .signature-area {
              margin-top: auto;
              padding-top: 50px; /* Ample space above signatures for pen signature / official stamp */
  ...
  return (
    <div className="w-full bg-[#faf9f6] py-8 sm:py-10 px-4 sm:px-6 lg:px-8">
      ...
      {mounted && activeNoticeModal && createPortal(
        <div className="notice-modal-wrapper fixed inset-0 z-[99999] flex items-center justify-center p-3 sm:p-6 font-sans animate-fade-in pointer-events-auto">
          {/* Backdrop */}
          <div
            className="no-print absolute inset-0 bg-slate-950/80 backdrop-blur-sm"
          ...
          <div className="notice-modal-card relative z-10 w-full max-w-3xl bg-white rounded-3xl overflow-hidden shadow-2xl border border-slate-200 flex flex-col max-h-[92vh] animate-fade-in-up">
            ...
            <div className="no-print w-full bg-[#004899] text-white px-5 sm:px-8 py-4 flex items-center justify-between select-none">
            ...
            <div id="official-notice-print-paper" className="p-6 sm:p-10 overflow-y-auto flex-grow bg-white text-slate-800 space-y-6">
              
              {/* Institutional Header with Logos */}
              <div className="flex flex-col items-center text-center pb-5 border-b-2 border-slate-300">
              ...
              {/* Memo Meta & Date Row */}
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between text-xs font-bold text-slate-600 pb-2 border-b border-slate-200 gap-2">
              ...
              {/* Notice Full Body */}
              <div className="text-xs sm:text-sm text-slate-800 leading-relaxed whitespace-pre-line space-y-3">
                {activeNoticeModal.body}
              </div>

              {/* Signatures & Seal with ample room for signing */}
              <div className="pt-14 mt-8 border-t-2 border-[#003366] flex flex-row justify-between items-end gap-3 text-xs w-full">
