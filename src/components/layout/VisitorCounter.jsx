...
export default function VisitorCounter() {
  ...
  // Listen for lightbox state changes across the site
  useEffect(() => {
  ...
  const isHidden = isFooterVisible || isLightboxOpen;

  return (
    <div 
      className={`fixed bottom-4 left-4 sm:bottom-5 sm:left-5 z-40 flex items-center select-none transition-all duration-300 ease-in-out ${
        isHidden 
