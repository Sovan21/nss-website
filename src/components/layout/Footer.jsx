      ...
      <div className="relative pt-12 pb-6 px-4 sm:px-8 lg:px-8 max-w-7xl mx-auto z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-6 mb-10">
          ...
          <div className="lg:col-span-2 lg:pl-4">
            <h4 className="text-white text-sm font-bold mb-4 tracking-wide uppercase">{t("footer.usefulLinks")}</h4>
            <ul className="space-y-3">
              {[
                { name: 'Kazi Nazrul University (KNU)', url: 'https://www.knu.ac.in/' },
                { name: 'RD NSS West Bengal', url: 'https://www.facebook.com/rdnsswb/' },
          ...
          <div className="lg:col-span-3">
            <h4 className="text-white text-sm font-bold mb-4 tracking-wide uppercase">{t("footer.connectWithUs")}</h4>
            ...
            <div className="p-4 rounded-xl bg-gradient-to-br from-white/[0.03] to-transparent border border-white/[0.05] inline-block w-full sm:w-auto">
              <p className="text-slate-500 text-[9px] font-bold uppercase tracking-[0.2em] mb-0.5">{t("footer.craftedBy")}</p>
              <p className="text-slate-200 text-[13px] font-bold tracking-wide">{t("footer.volunteer")}</p>
              <div className="w-6 h-px bg-white/10 my-2"></div>
              <p className="text-slate-400 text-[11px] leading-relaxed">
                {t("footer.ministry")}<br />
                <span className="text-slate-300 font-medium">{t("footer.govt")}</span>
              </p>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-slate-500 text-sm text-center md:text-left">
            © {new Date().getFullYear()} <span className="text-slate-300 font-medium">B.B. College NSS Unit</span>. {t("footer.copyright")}
          </p>
          <div className="flex items-center gap-6 text-sm">
            <a href="/terms" className="text-slate-500 hover:text-white transition-colors duration-300">{t("footer.terms")}</a>
            <a href="/privacy" className="text-slate-500 hover:text-white transition-colors duration-300">{t("footer.privacy")}</a>
          </div>
        </div>
